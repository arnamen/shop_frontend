...
import photo from '../../../public/assets/misc/woman-photo.jpg';

export default function AboutUs() {
    return (
        <div className={classes['about-us']}>
            <h1 className={classes['about-us__main-header']}>О компании</h1>
            <h1 className={classes['about-us__subtitle']}>Заголовок 1 уровня</h1>
            <span>
            Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa quis enim. Donec pede justo, fringilla vel, aliquet nec, vulputate eget, arcu.
            </span>
            <h2 className={classes['about-us__subtitle']}>Заголовок 2 уровня</h2>
            <span>
            ...
            <h3 className={classes['about-us__subtitle']}>Заголовок 3 уровня</h3>
            <span>
            ...
            <ul className={classes['about-us__list']}>
            ...
            <span> Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa quis enim. Donec pede justo, fringilla vel, aliquet nec, vulputate eget, arcu.</span>
            <img className={classes['about-us__image']} src={photo} alt='placeholder'/>
        </div>
    )
}
